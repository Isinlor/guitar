...
import { TrackFingering } from '@/model/types';
...
describe('Fingering Penalty Classes', () => {
  ...
  let trackFingering: TrackFingering;

  beforeEach(() => {
    trackFingering = [
      { note: 60,  fingering: { fret: 1, finger: 1, string: 1 }, ...irrelevant },
      { note: 62, fingering: { fret: 3, finger: 2, string: 1 }, ...irrelevant },
      { note: 64, fingering: { fret: 5, finger: 3, string: 2 }, ...irrelevant },
    ];
  });
  ...
  describe('CountLessUsedFingeringsPerNote', () => {
    it('should calculate penalty for less used fingerings', () => {
      const extendedTrack = [
        ...trackFingering,
        { note: 60, fingering: { fret: 2, finger: 2, string: 2 }, ...irrelevant }
      ];
